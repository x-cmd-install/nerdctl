...
合计: **101,662** 行代码（覆盖前 5 种语言、共 **853** 个文件）。
...
- **上游仓库**: <https://github.com/containerd/nerdctl>
- **许可证**: Apache-2.0
...
- **Star**: 10,389 · **Fork**: 830 · **开放 issue**: 1,453 · **贡献者**: 261

## 累计统计

- **发布数**: 98 · **已合并 PR**: 2987 · **开放 PR**: 54 · **已关闭 issue**: 1157 · **开放 issue**: 296 · **提交数**: 6717
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/nerdctl.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:50:51Z._
